...
export function Hero() {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Geometric Shapes */}
      <div className="absolute top-20 left-10 w-32 h-32 border-2 border-amber-500/20 rounded-lg" />
      <div 
        className="absolute bottom-20 right-10 w-40 h-40 border-2 border-blue-400/20"
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto w-full">
        <div>
          ...
          <h1 className="mb-3 sm:mb-6 text-4xl sm:text-5xl md:text-6xl lg:text-7xl leading-tight">
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-amber-200 to-amber-400 drop-shadow-[0_0_30px_rgba(251,191,36,0.3)]">
              ICOMAA
            </span>
          ...
          <div className="relative mb-8 sm:mb-12">
            <div className="inline-block relative">
              ...
              <div className="absolute -left-4 top-1/2 -translate-y-1/2 w-2 h-2 bg-amber-400 rounded-full"></div>
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-6 mb-8 sm:mb-12 max-w-3xl mx-auto">
            <div className="backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-2xl p-3 sm:p-6 hover:scale-105 transition-transform">
              <div className="text-2xl sm:text-4xl text-amber-400 mb-1 sm:mb-2">50+</div>
              <div className="text-white/80 text-xs sm:text-sm">Speakers</div>
            </div>
            <div className="backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-2xl p-3 sm:p-6 hover:scale-105 transition-transform">
              <div className="text-2xl sm:text-4xl text-amber-400 mb-1 sm:mb-2">15+</div>
              <div className="text-white/80 text-xs sm:text-sm">Countries</div>
            </div>
            <div className="backdrop-blur-md bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-2xl p-3 sm:p-6 hover:scale-105 transition-transform">
              <div className="text-2xl sm:text-4xl text-amber-400 mb-1 sm:mb-2">200+</div>
          ...
          <button
            ...
            className="bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-neutral-900 px-8 sm:px-12 py-4 sm:py-5 rounded-full shadow-[0_0_30px_rgba(251,191,36,0.4)] hover:shadow-[0_0_40px_rgba(251,191,36,0.6)] hover:scale-105 active:scale-95 transition-all text-sm sm:text-base relative overflow-hidden group"
          >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
        <div className="flex flex-col items-center gap-2">
          <div className="w-6 h-10 border-2 border-amber-400/50 rounded-full p-1 backdrop-blur-sm bg-white/5">
            <div className="w-1.5 h-3 bg-amber-400 rounded-full mx-auto"></div>
          </div>
        </div>
      </div>
    </section>
